...
func (q *Queries) UpdateUserCredential(ctx context.Context, arg UpdateUserCredentialParams) (User, error) {
	row := q.db.QueryRowContext(ctx, updateUserCredential, arg.ID, arg.Email, arg.HashedPassword)
	var i User
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
